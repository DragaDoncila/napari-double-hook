...
use_scm = {"write_to": "napari_double_hook/_version.py"}

setup(
    name='napari-double-hook',
    author='Draga Doncila Pop',
    author_email='ddoncila@gmail.com',
    license='MIT',
    url='https://github.com/DragaDoncila/napari-double-hook',
    description='Testing behaviour of plugins with multiple implementations of the same hook',
